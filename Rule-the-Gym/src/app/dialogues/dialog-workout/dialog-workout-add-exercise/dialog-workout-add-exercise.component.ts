...
export class DialogWorkoutAddExerciseComponent implements OnInit {
  ...
  addExerciseToWorkout(exercise: any) {
    console.log(this.data.workouts[this.data.index].exerciseMap)
    const tmp = new ExerciseDataModel(["3"],["8 -12"],["30"],["20"]);
    this.data.workouts[this.data.index].exerciseMap.set(exercise, tmp)
  }
